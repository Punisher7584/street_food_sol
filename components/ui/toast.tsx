...
// Custom toast hook and context for simple usage
...
// Toast context and hook for custom implementation
interface ToastContextType {
  toast: (props: Omit<CustomToastProps, "onClose">) => void
}
...
export function CustomToastProvider({ children }: { children: React.ReactNode }) {
  ...
  const toast = React.useCallback((props: Omit<CustomToastProps, "onClose">) => {
  ...
  return (
    <ToastContext.Provider value={{ toast }}>
      ...
      {toasts.map((toastProps) => (
        <CustomToast key={toastProps.id} {...toastProps} onClose={() => removeToast(toastProps.id)} />
      ))}
